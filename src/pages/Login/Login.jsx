...
const Login = () => {
    ...
    return (
        <div className='max-w-[1200px] px-4 mx-auto flex flex-col md:flex-row items-center justify-center gap-5 my-20'>
            ...
            <div className='w-full md:w-2/4 lg:w-2/5 py-10 border md:mr-2'>
                ...
                <form  className='w-4/5 lg:w-2/3 mx-auto'>
                    ...
                    <input type="submit" value="Login" className='w-full btn border-0 normal-case hover:bg-[#FF3811] hover:text-white  bg-[#E76F51] text-white py-3 my-5 rounded-md font-semibold' />
                </form>
                <div className='w-2/3 mx-auto'>
                    ...
                    <p className='text-center'>New to this website ? <Link to="/singUp" className='text-red-500 font-semibold'>Sing up</Link></p>
                </div>
            </div>
        </div>
    );
